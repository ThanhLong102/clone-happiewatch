...
function Header({handleDisplayCart,totalItems,handleDisplaySearch,handleDisplay,handleDisplayLogin,login,handleDisplayLogout}) {
        ...
        <div className="header" onClick={handleDisplay}>
            ...
            <div className="header_items">
                ...
                <Link to='/upload' style={{textDecoration: 'none' }}>
                    <MenuIcon className="header_item"  fontSize="small"/>
                </Link>
            </div>
        </div>
    );
