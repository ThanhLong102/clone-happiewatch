...
function Home() {
    ...
    useEffect(() =>{
        setInterval(() =>{
            ...
            setPost(news[Math.floor(Math.random() * news.length) ]);
        },10000);
    },[]);
        ...
        <div className="content">
            <Link to='/collection' style={{textDecoration: 'none' }}>
                <div className="content_news">
                    <img src={post} alt=''/>
                    <img className="content_new" src="https://cdn.shopify.com/s/files/1/0477/6699/5109/files/collection0803.jpg?v=1627962818" alt=''/>
                </div>
            </Link>
            ...
            <div className="signUp">
                <div className="form_signup">
                    ...
                    <form>
                        ...
                        <input className="submit_container" type="submit" value="Submit"/>
                        <div className="icons">
